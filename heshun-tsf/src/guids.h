...
// Windows' standard language-bar item identity for an IME input-mode button.
// WeaselTSF registers this GUID rather than its own private button GUID.
inline constexpr GUID GUID_LBI_INPUTMODE_HESHUN =
