...
fn runtime_event(event: &HsRuntimeEvent) -> Option<InputEvent> {
 ...
 6 => CandidateSource::TableCompletion, 2 => CandidateSource::ScriptExact, 3 => CandidateSource::ScriptSentence, 4 => CandidateSource::ScriptPrefix, 5 => CandidateSource::Reverse, _ => return None }, ordinal: event.ordinal }),
