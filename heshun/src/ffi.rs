...
fn runtime_event(event: &HsRuntimeEvent) -> Option<InputEvent> {
    Some(match event.opcode {
        ...
        4 => InputEvent::Space,
        5 => InputEvent::Enter,
        6 => InputEvent::Select(CandidateKey { source: match event.source { 1 => CandidateSource::Table,
 6 => CandidateSource::TableCompletion,
 7 => CandidateSource::ScriptAbbreviation, 2 => CandidateSource::ScriptExact, 3 => CandidateSource::ScriptSentence, 4 => CandidateSource::ScriptPrefix, 5 => CandidateSource::Reverse, _ => return None }, ordinal: event.ordinal }),
        7 => InputEvent::MoveSelection(event.value as i32),
        13 => InputEvent::MoveCursor(event.value as i32),
